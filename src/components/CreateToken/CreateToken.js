...
export default function CreateToken(props) {
  ...
  return (
    <Card>
      ...
      <CardBody>
        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={3}>
            <TextField id="tokenname" label="Name" variant="standard" />
          </GridItem>
          <GridItem xs={12} sm={12} md={3}>
            <TextField id="tokensymbol" label="Symbol" variant="standard" />
          </GridItem>
          <GridItem xs={12} sm={12} md={3}>
            <TextField id="tokendecimal" label="decimal" type="number" variant="standard" />
          </GridItem>
          <GridItem xs={12} sm={12} md={3}>
            <TextField
              id="totalsupply"
        ...
        <div>
          <FormControlLabel
            control={
              <Switch
                checked={owner_switch}
                onChange={ownerSwitchChange}
                color="info"
          ...
          {owner_switch && (
            <GridContainer justifyContent="center">
              <GridItem xs={12} sm={12} md={11}>
                <TextField label="Create/Owner Address" id="owneraddr" variant="standard" fullWidth />
              </GridItem>
            </GridContainer>
          )}
        </div>
          ...
          <div>
            ...
            {!lp_switch && (
              <FormControlLabel
                control={
                  <Switch
                    checked={buyback_switch}
                    onChange={buyback_change}
                    color="info"
                    inputProps={{ 'aria-label': 'controlled' }}
                  />
                }
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={holder_switch}
                  onChange={holder_change}
                  color="info"
                  inputProps={{ 'aria-label': 'controlled' }}
                />
              }
            ...
            {lp_switch && (
              <GridContainer justifyContent="center">
                <GridItem xs={12} sm={12} md={11}>
                  <TextField id="lp_fee" label="Automatic LP(%)" type="number" fullWidth variant="standard" />
                </GridItem>
              </GridContainer>
            )}
          </div>
      ...
      <GridContainer justifyContent="center">
        <GridItem xs={12} sm={12} md={3}>
          <Button color="info" onClick={(e) => handleCreatetoken()} variant="contained">
            Create Token
          </Button>
        </GridItem>
      </GridContainer>
